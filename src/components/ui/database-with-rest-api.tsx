...
const DatabaseWithRestApi = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[350px] max-w-7xl mx-auto  flex-col justify-center items-center ",
        className
      )}
    >
      {/* SVG Paths  */}
      ...
      {/* Main Box */}
      <div className="absolute bottom-10 flex   flex-col w-10/12 mx-auto items-center">
        {/* bottom shadow */}
        ...
        {/* box content */}
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-transparent backdrop-blur shadow-md">
          {/* Badges */}
          ...
          {/* Circles */}
          <motion.div
            className="absolute -bottom-14 h-[100px] w-[100px] rounded-full border-t border-2 bg-accent/5"
            animate={{
